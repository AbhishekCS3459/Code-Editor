...
const LanguageSelector = () => {
    ...
    return (
        <select disabled = {isDisabled} value={languageValue} className="font-semibold w-[100px] py-1 px-1 rounded border-none outline-none cursor-pointer text-black" onChange={onChange}>
            {
